...
{
  "$end", "error", "$undefined", "IDENTIFIER", "I_CONSTANT", "TSEMI",
  "TEQUAL", "$accept", "program", "translation_unit", "declaration",
...
#line 54 "parser.y" /* yacc.c:1646  */
    { (yyval.declaration) = new NVariableDeclaration(*(yyvsp[-2].ident), *(yyvsp[-1].ident)); }
#line 1241 "parser.cpp" /* yacc.c:1646  */
    break;

  case 6:
#line 55 "parser.y" /* yacc.c:1646  */
    { (yyval.declaration) = new NVariableDeclaration(*(yyvsp[-4].ident), *(yyvsp[-3].ident), (yyvsp[-1].expr)); }
